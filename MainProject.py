...
# cap = cv2.VideoCapture('E://detection//videoplayback.mp4')
...
while True:
    ...
    cv2.imshow("Frame",frame)                                               #outputs the window to user
...
Voiceit.speak('Thanks for using Motion detection program made by TRIADS. Press enter to exit')
input()